...
def login():
    ...
    if anonymous_login.get():
        messagebox.showinfo("Login Successful", "Welcome, anonymous!")
        open_main_window("anonymous")
    else:
...
def open_main_window(username):
    ...
    translate_button = tk.Button(main_window, text='SLTS', font=('Helvetica', 12), command=start_translation)
    translate_button.pack(pady=20)

def start_translation(): # 수화번역창 띄우기
    try:
        def get_args():
        ...
        messagebox.showerror('오류', f'수화 번역 프로그램을 시작하는 중 오류가 발생했습니다: {e}')#
...
def open_signup_window():
    global entry_username, entry_password, entry_confirm_password, signup_window
    ...
    entry_username = tk.Entry(signup_window, bg="#f9f9f9", font=("Helvetica", 12))
    ...
    entry_password = tk.Entry(signup_window, show="*", bg="#f9f9f9", font=("Helvetica", 12))
    ...
    entry_confirm_password = tk.Entry(signup_window, show="*", bg="#f9f9f9", font=("Helvetica", 12))
...
entry_username = tk.Entry(frame_login, bg="#f9f9f9", font=("Helvetica", 12))
...
entry_password = tk.Entry(frame_login, show="*", bg="#f9f9f9", font=("Helvetica", 12))
entry_password.grid(row=1, column=1, pady=5)

# Anonymous login option
anonymous_login = tk.BooleanVar()
anonymous_login_checkbox = tk.Checkbutton(frame_login, text="Anonymous Login", variable=anonymous_login, bg="#f0f0f0",
                                          font=("Helvetica", 10))
anonymous_login_checkbox.grid(row=2, columnspan=2)
